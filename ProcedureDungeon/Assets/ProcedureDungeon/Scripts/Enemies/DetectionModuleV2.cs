...
public class DetectionModuleV2 : MonoBehaviour
{    
    ...
    void Start()
    {
        ...
        DebugUtility.HandleErrorIfNullFindObject<ActorsManager, DetectionModuleV2>(m_ActorsManager, this);
    }
    ...
    public void HandleTargetDetection(Actor actor, Collider[] selfColliders)
    {
        ...
        float closestSqrDistance = Mathf.Infinity;//esta variable creo que no aporta en nada
