...
namespace WNA.Weapon
{
    ...
    public class Weapon : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            m_InputHandler = GetComponent<Inputs>();
            m_PlayerCharacterController = GetComponent<FirstPersonController>();
            SetFov(DefaultFov);
        ...
        //        if (m_PlayerCharacterController.enableJump)
        //        {
        //            characterMovementFactor =
        //                Mathf.Clamp01(playerCharacterVelocity.magnitude /
        //                              (m_PlayerCharacterController.maxVelocityChange *
        //                               m_PlayerCharacterController.sprintSpeed));
        //        }
